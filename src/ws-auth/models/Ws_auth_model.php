 ...
 * @ahmetson
 *
 * Forked from: Ben Edmunds' Ion Auth library
 *
 * Created:  28.12.2019
 *
 * Description:  Modified auth system based on ion_auth with dealing with Symfony's Session library, instead of native sessions.
 *
...
/**
 * Class Ws Auth Model
 * @property Ws_auth $ws_auth The ws_auth library
 */
class Ws_auth_model extends CI_Model
{
	/**
